  ...
  <div class="bg-gray-300">
    ...
    <div class="flex bg-green-100">
      ...
      >
        <div class="xl:max-w-lg xl:ml-auto">
          ...
          <img
            class="mt-4 rounded-lg shadow-xl sm:mt-8 sm:h-72 sm:w-full sm:object-cover sm:object-center lg:hidden"
            src="/img/demo.jpg"
            alt="img"
          />
          <h1
            class="mt-6 text-2xl font-bold text-gray-900 leading-tight sm:text-4xl sm:mt-8 lg:mt-4 lg:text-3xl xl:text-4xl"
          >
          ...
          <p class="mt-2 text-gray-600 sm:text-xl sm:mt-4">
            Workcation helps you find work-friendly, rentanls in beautiful
            locations so you can enjoy some nice weather even when you are not
            on vacation.
          </p>
          <div class="mt-4 sm:mt-6">
            <v-link
              class="btn btn-primary sm:text-base shadow-lg"
              href="/listings"
              >Book your escape</v-link
            >
    ...
    <div>
      <div class="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
        <h2 class="text-xl text-gray-600">Popular destinations</h2>
