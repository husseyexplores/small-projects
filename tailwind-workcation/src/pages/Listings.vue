...
<!--
  ...
  <div class="min-h-screen bg-gray-200 antialiased">
    <header class="bg-gray-900 px-4 py-3 flex justify-between">
      <div>
    ...
    <section class="bg-gray-800 px-4 py-3 flex justify-between">
      <div class="relative">
        ...
        <input class="bg-gray-900 w-full text-white rounded-lg pl-10 pr-4 py-2 focus:outline-none focus:bg-gray-200 focus:text-gray-900" type="text" placeholder="Search by keywords"/>
      </div>
      <button class="inline-flex bg-gray-700 rounded-lg shadow pl-3 pr-4 ml-4 items-center hover:bg-gray-600 focus:outline-none focus:shadow-outline">
        <svg class="h-6 w-6 fill-current text-gray-500" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 6a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H4a1 1 0 0 1-1-1zm3 6a1 1 0 0 1 1-1h10a1 1 0 1 1 0 2H7a1 1 0 0 1-1-1zm4 5a1 1 0 1 0 0 2h4a1 1 0 1 0 0-2h-4z"></path></svg>
        ...
        <div class="">
          ...
          <div class="px-4 -mt-16 relative">
            <div class="bg-white rounded-lg px-4 py-3 shadow-lg">
              <div class="flex">
                <span class="bg-teal-200 text-teal-800 font-semibold rounded-full uppercase tracking-wide text-xs px-2 py-1 leading-none inline-block">Plus</span>
                <div class="ml-2 text-xs text-gray-600 font-semibold uppercase tracking-wide">3 beds &bull; 2 baths</div>
              </div>
              <h4 class="mt-1 text-gray-900 font-semibold text-lg">Modern home in city center</h4>
              <div class="mt-1">
                <span class="text-gray-900">$1,900.00</span><span class="ml-1 text-gray-600 text-sm">/wk</span>
              </div>
